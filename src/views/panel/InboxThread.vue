                ...
                <div class="p-6">
                    ...
                    <div v-else>
                        <div style="height: 300px; overflow: auto;">
                            <div v-for="(item, index) in search.search_results" :key="index"
                                class="pb-1 text-sm"
                            >
                                {{ item.name }}
                        ...
                        <div class="lf-chat-inbox-item-middle">
                            <div class="lf-chat-inbox-item-contact" style="line-height: 22px; font-size: 14px;">
                                ...
                                <span v-if="business">
                                    ...
                                    <span v-else style="color: red;">{{ business.phone_number_type }}</span>
                                </span>
                            </div>
    ...
    methods: {
        ...
        async sendMessage() {
            ...
            let params = {
             ...
             await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/send-message', params, {
                headers: {
                'Authorization': 'Bearer ' + this.$store.state.auth.jwt
                },
            })
        ...
        async archiveThread() {
             await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/archive-thread', {
                threadId: this.thisThreadId
            }, {
                headers: {
                'Authorization': 'Bearer ' + this.$store.state.auth.jwt
        ...
        async unarchiveThread() {
            await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/unarchive-thread', {
                threadId: this.thisThreadId
            }, {
                headers: {
                'Authorization': 'Bearer ' + this.$store.state.auth.jwt
        ...
        async deleteThread() {
            await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/delete-thread', {
                threadId: this.thisThreadId
            }, {
                headers: {
                'Authorization': 'Bearer ' + this.$store.state.auth.jwt
        ...
        async confirmSendImage(image_url) {
            await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/confirm-send-image', {
                threadId: this.thisThreadId,
                image_url: image_url
            }, {
                headers: {
        ...
        async declineSendImage(image_url) {
             await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/decline-send-image', {
                threadId: this.thisThreadId,
                image_url: image_url
            }, {
                headers: {
        ...
        async sendSelectedScreenshotPush(selection, business = null) {
           ...
           await axios.post(process.env.VUE_APP_API_ENDPOINT + '/inbox/send-screenshot', {
                threadId: this.thisThreadId,
