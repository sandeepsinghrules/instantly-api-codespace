        ...
        <div class="rg-auth-left">
            ...
            <div class="rg-auth-left-logo">
                <router-link :to="(($agency) ? '/login' : '/')" class="mb-12">
                    <img v-if="!$agency" src="@/assets/Logo-2.webp" alt="" style="width: 200px; margin-top: -10px;" />
                </router-link> 
            </div>

            <div class="rg-auth-left-content p-4">
                <div class="rg-auth-left-content-title">Powerful API Stack<br />For Data-Driven Marketers</div>
            ...
            <div class="rg-auth-right-content">
                <div class="rg-auth-right-logo">
                    <router-link :to="(($agency) ? '/login' : '/')" class="mb-12">
                        ...
                        <img v-if="!$agency" src="@/assets/Logo-2.webp" alt="" style="width: 250px;" />
                        <span v-if="$agency">
